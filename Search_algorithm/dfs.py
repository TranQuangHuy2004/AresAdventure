...
def dfs(initial_Ares_pos, initial_stones_pos, grid, stone_weights, switch_pos):
    ...
    # LIFO stack with (Ares_position, Stones_positions, solution_path, pushed_weight)
    stack = [(initial_Ares_pos, initial_stones_pos, "", 0)]
    ...
    while stack:
        Ares_pos, stones_pos, solution_path, cost = stack.pop()
        ...
        for dir_index, (dx, dy) in enumerate(dir.DIRECTIONS):
            ...
            if new_Ares_pos in stones_pos:
                ...
                if (new_Ares_pos, tuple(new_stones_pos)) not in visited:
                    ...
                    stack.append((new_Ares_pos, new_stones_pos,
                ...
                if (new_Ares_pos, tuple(stones_pos)) not in visited:
                    ...
                    stack.append((new_Ares_pos, stones_pos,
                                  new_solution_path, new_cost))
